...
REVENUE_MODEL = {
    "revenue_per_trip_usd": 4.73,                      # Blended from 82.4% member / 17.6% casual actual split
...
OPPORTUNITY_COST = {
    "lost_trip_revenue_usd": 4.73,                     # Blended revenue per trip (from cost_of_inaction.py)
